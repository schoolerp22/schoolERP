  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 col-span-2 md:col-span-1 lg:col-span-1">
          <div className="flex items-center justify-between">
            <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 mb-20 md:mb-0">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Quick Actions</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <button
            onClick={() => onViewChange('attendance')}
            className="p-3 md:p-4 border-2 border-indigo-200 rounded-xl md:rounded-lg hover:bg-indigo-50 transition-colors active:scale-95"
          >
          ...
          <button
            ...
            className="p-3 md:p-4 border-2 border-green-200 rounded-xl md:rounded-lg hover:bg-green-50 transition-colors active:scale-95"
          >
          ...
          <button
            ...
            className="p-3 md:p-4 border-2 border-yellow-200 rounded-xl md:rounded-lg hover:bg-yellow-50 transition-colors active:scale-95"
          >
          ...
          <button
            ...
            className="p-3 md:p-4 border-2 border-purple-200 rounded-xl md:rounded-lg hover:bg-purple-50 transition-colors active:scale-95"
          >
